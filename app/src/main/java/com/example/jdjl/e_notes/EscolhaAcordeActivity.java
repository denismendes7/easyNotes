...
public class EscolhaAcordeActivity extends AppCompatActivity {
    ...
    private Button btnMaiores, btnMenores, btnSusMaiores, btnSusMenores;
    Bundle parametros;
    ...
    protected void onResume() {
        ...
        btnSusMaiores = (Button) findViewById(R.id.btnSusMaiores);
        btnSusMaiores.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vaiPraTelaDosAcordes = new Intent(EscolhaAcordeActivity.this, NotasSustenidosActivity.class);
                parametros = new Bundle();
                parametros.putString("valor", "susMaiores");
                vaiPraTelaDosAcordes.putExtras(parametros);
                startActivity(vaiPraTelaDosAcordes);
            }
        });

        btnSusMenores = (Button) findViewById(R.id.btnSusMenores);
        btnSusMenores.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vaiPraTelaDosAcordes = new Intent(EscolhaAcordeActivity.this, NotasSustenidosActivity.class);
                parametros = new Bundle();
                parametros.putString("valor", "susMenores");
                vaiPraTelaDosAcordes.putExtras(parametros);
                startActivity(vaiPraTelaDosAcordes);
            }
        });
